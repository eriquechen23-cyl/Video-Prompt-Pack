...
- episode_index：1
- slug：wind-scar-mist-emperor_v02
...
- goal：製作 15 秒 12 幕 2D 日系動漫風格分鏡，呈現風見迅以風痕瞬步壓縮瘴霧，漫畫分格終結腐蝕核心，並全程提供日文配音（青年男聲）
...
- 配音：日文青年男聲，低冷語氣；錄製 -16 LUFS，保留呼吸與氣口，與 SFX 分離輸出。
...
- CTA：結尾 0.5s 疊字「フォローで次の狩りへ」；字幕語言：繁中＋少量日文字，無英文 UI；VO 全程日文配音（青年男聲，氣音偏冷）。
- 切片策略：原聲保持風與霧腐蝕聲，必要時降低音樂至 -16 LUFS 留下空氣感；VO 軌道獨立輸出方便字幕對齊。
...
Audio & Transition：VO（日文青年嗓，冷淡語氣）「匂い、最悪だな」-12 dB；手腕骨節聲 -18 dB，風線低鳴與衣料摩擦；直接切到 Beat3。
...
Audio & Transition：VO（日文，帶笑語氣）「風属性で毒霧を裂く。相剋だな。」-11 dB；火花噼啪 -10 dB；音樂節奏提升至 94 BPM 對應奔跑；鞭移至 Act II。
...
Audio & Transition：VO（日文，低沉收尾）「風向は、俺が決める」-10 dB；風聲漸弱，粉塵落地聲，音樂收束留尾音；硬切黑場。
Angle：三分構圖，迅位於左側，背景夜空星點，補充：遠處港燈重新亮起形成散景。

## Platform Layer（字幕/Caption/Hook 重申）
- 字幕時間軸：
  - 0.8s：「味道真爛。（匂い、最悪だな）」
  - 4.1s：「風屬性對上毒霧嗎——相剋，正好。（風属性で毒霧を裂く。相剋だな。）」
  - 12.6s：「音速連拳——終端。（音速連拳——終端）」
  - 14.5s：「風向，還是我說了算。（風向は、俺が決める）」
