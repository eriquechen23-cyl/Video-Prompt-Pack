# 蓄壓重槌師 EP02 — 朝倉蓮・雷槌一擊 vs 角質巨獸 BOSS PV Prompt（15s｜12 幕｜9:16 直式）

來源劇本：用戶提供《雷槌一擊・朝倉蓮 vs 巨獸》文案與 12 幕提示（2D 日系動漫風）

## Input Registry
- project_name: 蓄壓重槌師
- series_name/arc: 蓄壓重槌師・廢墟平原雷擊線
- episode_index: 2
- slug: thunder-maul-vs-keratin-behemoth_v01
...
- goal: 轉為「巨槌＋雷元素」版本，除擊殺的一幕外維持正常 2D 動畫風，漫畫感僅限最後擊殺瞬間；強化雷光、慣性、PBR 質感

## 一句話題材
正午廢墟平原上，朝倉蓮扛著雷紋巨槌迎向角質骨刺巨獸，從啟動雷紋、蓄力衝刺到最終雷槌一擊，僅在擊殺瞬間切入漫畫分鏡，其餘畫面保持乾淨黑黃 2D 動畫質感與飽和雷光。
...
- Default: ON
- Visual traits:
  - 雷紋採金黃＋藍白雙層，槌頭刻紋有 0.5mm 刻線並填充 emissive；漫畫格開啟時背景改為黑白網點與速度線，雷光保持彩色，擬聲字以粗黑邊＋內亮描寫「ドガァァァンッ」。
...
- Emotion & Performance：蓮壓低身體如拉弓，眼神鎖定巨獸腹部；低聲台詞「次で終わらせる。」
...
#### Beat 12（13.2–15.0s）｜漫畫感雷槌擊殺・唯一漫畫分鏡幕｜延續軸線、光位、Stage3→崩解、Lens 55mm 兩段處理
- Camera：第一瞬間切換漫畫分鏡，黑白網點＋速度線，中景正打；雷槌砸中巨獸頭部，中央白閃佔滿 40% 畫面；擬聲字「ドガァァァンッ！！」佔上半部。0.3–0.5s 後立刻切回正常動畫，鏡頭拉遠至 6m 眼高，看巨獸崩解、蓮半跪握槌。
- Lighting：漫畫格保留雷光彩色，其他轉黑白，光線方向仍右上 45°；回到動畫後雷光餘暈漸熄，地面留下焦黑燒痕。
- Materials & Physics：擊中瞬間巨獸角質崩解成黑碎片與金黃光點，飛散半徑 6m；槌頭插地震出放射狀裂紋，碎石落地遵循重力；雷紋亮度快速衰減至 20%。
- Emotion & Performance：蓮落地半跪，肩膀微喘，低頭看著碎片；台詞「…静かになったな。」嘴型對應，表情安靜。
...
- 漫畫格使用範圍收斂為擊殺瞬間唯一一幕；其他幕保持正常 2D 動畫光影。
