...
- Boss stage timeline：T0–3s Stage A 完整冰甲；T3–7s Stage B 龍息拉出裂紋；T7–10s Stage C 核心曝光並脈動；T10–15s Stage D 崩解為冰晶雪崩。
- Hero state timeline：T0–2s 充能 30% 邊走邊響；T2–6s 充能 65%、風雪黏在斗篷；T6–9.6s 充能 95%、指節泛白與呼吸白霧；T9.6s 發射後冷卻 50℃ 蒸汽包覆肩膀。
...
- Worldstate snapshot（UTC+8 2025-11-24 夜）：極寒裂谷長夜，風像亡魂 7 m/s 刮過斷橋與冰封城牆，戰旗與碎石凍在半空；雪花像停住的白點，遠處熔岩縫隙 3200K 紅光脈動；冰龍呼吸時裂縫沿地表延伸。
- Lead: 朝倉蓮，185cm 壯碩，厚底鐵靴重 3.2kg/隻，肩扛 28kg 充能重弩，能量槽從暗紅→金黃→炙白跳動；面容以參考頭像，膚色 55–65 IRE，左眉疤清晰。
- Intent: 15 秒決戰，9–10 幕彩色漫畫分鏡呈現「最後一矢」擊殺，之後回到 2D 動畫靜落雪；風格 2D 日系動漫 + 豐富粒子。
- Camera continuity: 遵循 Axis 與 Distance curve；鞭移、遮擋轉場維持風向一致；漫畫格跳切後用燒蝕回復。
- Constraints list: 保持蓮右、龍左；能量槽亮度循序升高不回落；冰龍核心在 Stage C 必須露出脈動紋；無字幕、無 Logo；雪花停止或再度飄落需與音樂拍點對齊。
- Execution note: camera projection 固定冰牆與懸浮戰旗；Volume pass 體積霧 0.35；龍息與冰晶使用 Houdini flipbook 16×16；Denoise 限制 0.35 strength；漫畫格禁用 motion blur。
- Physics & PBR: 冰面粗糙度 0.12、IOR 1.31；冰牆厚 1.1m、折射變形 3%；熔岩縫隙 680℃ 產熱扭曲 0.8%；重弩金屬度 0.8 粗糙 0.35，能量槽玻璃 IOR 1.5；布料粗糙 0.55、法線 4k，斗篷邊緣冰霜厚 1mm；龍息冰霜粒徑 0.5–1.2mm。
...
Act I（0.0–4.8s）｜意圖：凝結世界與登場壓迫｜基調：靜止→預兆｜節奏域：慢入 1.2s
美術要點：冰封斷橋、凍在半空的戰旗與碎石、冰牆刻紋、雪點定格。

Beat 1（0.0–1.2s）｜重點：極寒裂谷被凍住的瞬間
Blocking：俯視掃過裂谷，風像亡魂拉出雪線；無角色入畫。
Camera：滑軌俯拍 24mm 眼高；對焦前→中→後；快門 180。
光影：冷月 5200K 主光，熔岩 3200K 下打反光；對比柔中高。
色調/LUT：陰影微藍，高光暖 8%。
聲音：風聲拖尾 -12 dB；遠處低頻龍吼 -15 dB；音樂氛圍 pad 70 BPM。
物理/質感：雪花粒徑 0.4mm 定格；冰面粗糙 0.12；體積霧 0.35；重力 9.8 m/s²，但龍息區域局部懸浮。
轉場：直接切 → Beat2。
Angle A1
構圖：三分線＋前中後層次，留白 15%。
內容：斷裂石橋、懸浮戰旗與碎石、雪點像停住的白墨點。
補充：遠方雲層逆時針 0.2 rad/s 旋；冰牆法線刻紋 0.4mm 深。
安全：無可讀字。

Beat 2（1.2–2.4s）｜重點：冰龍抬頭、裂紋被呼吸拉開
Blocking：冰龍自裂谷抬首，翅膀展開時冰晶抖落，吐息讓地表裂縫延伸。
Camera：仰角穩定器 28mm 胸高；對焦單點龍瞳；快門 180。
光影：主光冷月側逆，龍鱗 Fresnel 反射；對比高。
色調/LUT：藍白主調，膚色保護。
聲音：冰晶掉落叮噹 -10 dB；龍吼 -6 dB；裂縫拉伸「ギギ」-8 dB。
物理/質感：龍鱗金屬度 0.25 粗糙 0.3；翅膀帶風 8 m/s；裂縫寬度從 5cm → 18cm。
轉場：鞭移跟到蓮入畫。
Angle A2
構圖：中央壓迫，龍瞳佔 1/3 畫幅。
內容：龍瞳倒映裂谷與遠處人影，冰紋 2Hz 脈動。
補充：冰晶向鏡頭飛並被景深拉絲；粒子受風偏移 12°。
安全：無 Logo。

Beat 3（2.4–3.6s）｜重點：蓮踏入畫面，重弩充能律動
Blocking：側移跟拍蓮的重靴踩碎冰，能量槽每步跳一次。
Camera：側向滑軌 24mm 腰高；層次拉焦腳→弩→臉；快門 180。
光影：主光右上，熔岩紅反射到弩身刻紋。
色調/LUT：陰影微藍，高光暖 10%。
聲音：腳步鈍響 -8 dB 帶金屬顫；能量槽「ドン」脈動；音樂節奏 84 BPM。
物理/質感：冰面摩擦 0.35，鞋底鐵釘刮出 0.3mm 白痕；能量槽表面 45℃ 微蒸汽。
轉場：遮擋切到就位。
Angle A3
構圖：前景重弩佔 40%，中景蓮半身。
內容：弩臂發光紋路像流動電流，肩肌頂起斗篷。
補充：能量亮度從 20%→60%（0.8s），斗篷被風推開 6°。
安全：無字幕。

Beat 4（3.6–4.8s）｜重點：藏身破碎冰牆後預備
Blocking：半跪破冰牆後，插入能量箭頭，龍息前兆吹來，手指搭上扳機。
Camera：35mm 膝高；對焦箭矢→指節；快門 180。
光影：體積霧穿過冰牆刻紋；局部高光 5200K；對比中高。
色調/LUT：膚色優先，去飽和 5%。
聲音：金屬摩擦「キィ」-7 dB；箭矢插入「カチ」-6 dB；風聲升到 -10 dB。
物理/質感：箭矢金屬度 0.75 粗糙 0.28；冰牆折射變形 3%；指節白化、手套皮革粗糙 0.5。
轉場：光源匹配 → Act II。
Angle A4
構圖：過肩特寫，留白 10%。
內容：扳機與指節特寫，冰牆裂紋映出龍影。
補充：0.1s 蒸汽噴出；箭矢紋路由暗紅→金黃。
安全：無文字。

Act II（4.8–9.6s）｜意圖：暴風與蓄壓堆疊｜基調：決斷｜節奏域：穩定 1.2s
美術要點：暴風雪、冰牆護遮、能量槽逼近飽和。

Beat 5（4.8–6.0s）｜重點：龍息暴風席捲，裂紋擴大
Blocking：龍息轟下覆蓋畫面，冰牆前景瞬凍，蓮低頭護弩。
Camera：側拉 32mm 腰高；對焦龍息粒子→冰牆→蓮肩；快門 172。
光影：龍息體積光藍白，熔岩紅打出反邊；對比高。
色調/LUT：冷藍主，弩身暖金點亮。
聲音：龍息轟鳴 -4 dB；冰凍聲 -7 dB；衣料摩擦 -12 dB。
物理/質感：龍息粒度 0.7mm、溫度 -40℃；冰牆表面粗糙 0.18；蓮被風推後滑 0.2m。
轉場：鞭移沿裂縫掃向核心方向。
Angle A5
構圖：前景冰牆 60%，龍息從左上斜切；蓮剪影在右。
內容：冰霜沿裂紋蔓延，重弩能量槽在霧中閃。
補充：裂紋厚度 0.2cm，粒子拖光條 12px。
安全：去 Logo。

Beat 6（6.0–7.2s）｜重點：重弩蓄壓逼近飽和
Blocking：蓮靠冰牆穩定姿態，能量槽亮到 85%，汗霧化。
Camera：45mm 膝高；呼吸拉焦能量槽→蓮眼；快門 180。
光影：主光側逆，能量槽自發光 4000K；對比高。
色調/LUT：暖金對冷藍，膚色保護。
聲音：充能嗡鳴 -5 dB；心跳低頻 -10 dB；風聲壓制到 -14 dB。
物理/質感：重弩震動 3mm；額頭汗蒸發 0.2s；手套摩擦係數 0.55 固定握力。
轉場：遮擋切到瞄準視角。
Angle A6
構圖：側面中近景，重弩佔 50%，蓮臉佔 30%。
內容：能量槽從金黃→炙白，弩身刻紋被熱扭曲 1.5%。
補充：斗篷被風吸附冰晶，布料法線 4k 清晰。
安全：無字幕。

Beat 7（7.2–8.4s）｜重點：冰牆碎裂，核心首次露出
Blocking：龍息停頓，冰牆炸開一道縫，核心藍光外露；蓮抬槍鎖定。
Camera：主觀 40mm 眼高；層次拉焦碎冰→核心；快門 180。
光影：裂縫藍光 4800K 照亮碎冰；對比高。
色調/LUT：藍白主調，暖金箭尖點對比。
聲音：碎冰「パリン」-8 dB；充能提升「ヴォン」-6 dB；音樂推到 90 BPM。
物理/質感：碎冰粒徑 1–4mm；裂縫擴張 0.3m；肩膀因後座預壓 6°。
轉場：光源匹配 → Beat8。
Angle A7
構圖：準星置中核心，留白 12%。
內容：核心脈動 2Hz，裂紋分支向四周。
補充：T0 碎冰飛散，T0+0.4s 準星微晃後穩定，T0+0.8s 呼吸吐霧。
安全：無文字。

Beat 8（8.4–9.6s）｜重點：最後一矢前的子彈時間
Blocking：蓮低語「ここからは一矢」、手指扣扳機，時間被拉長，能量槽亮度頂點。
Camera：主觀 50mm；層次拉焦扳機→箭尖→核心；快門 180。
光影：主光維持，核心脈動閃到 3Hz；對比高。
色調/LUT：暖金與冷藍分區，膚色保護。
聲音：心跳疊音 + 充能長鳴；音樂抽空 0.3s 僅留呼吸與扳機聲。
物理/質感：扳機行程 5mm；能量槽溫度 160℃，蒸汽帶走 0.1g 水氣；重弩後座預計 6°。
轉場：時間縮放 → 漫畫格 Act III。
Angle A8
構圖：箭尖佔前景 30%，核心在三分線；留白 10% 供速度線進場。
內容：能量線條沿弩身聚向箭尖，瞳孔縮至 2.5mm。
補充：T0 扣下，T0+0.3s 能量拉絲，T0+0.6s 速度線拉滿畫面。
安全：無文字。
Act III（9.6–15.0s）｜意圖：擊殺與靜落｜基調：爆發→寧靜｜節奏域：加速 1.2s → 慢收
美術要點：彩色漫畫爆裂後回到冷藍雪景，冰晶雪崩緩落。

Beat 9（9.6–10.8s）｜重點：漫畫格「最後一矢」刺入核心（擊殺①）
Blocking：時間凍成彩色漫畫分鏡，箭矢拖光尾衝刺核心，速度線佔 45% 畫幅。
Camera：多格分鏡，主格 70% 斜上角度；無 DOF；快門 200；Style: Chromatic Comic Burst。
光影：平光高對比，CMYK 網點；主光均勻。
色調/LUT：飽和 +20%，對比 +20%。
聲音：擬聲「ドゴォン!!」-8 dB 疊音；鼓點同步。
物理/質感：箭矢穿刺深度 0.6m；裂紋以 400 m/s 向外擴；冰晶破碎 1–3mm 粒徑。
轉場：漫畫格持續。
Angle A9（Style: Chromatic Comic Burst）
構圖：主格箭矢刺入核心佔 70%，小格瞳孔特寫 2 格。
內容：粗黑線條＋彩色網點；速度線覆蓋背景；擬聲字漂浮爆點。
補充：小格顯示瞳孔收縮、胸口冰紋龜裂；無景深。
安全：無品牌。

Beat 10（10.8–12.0s）｜重點：漫畫格崩解爆散（擊殺②）
Blocking：冰龍沿裂縫崩解成冰晶雪崩，主角剪影背對爆點。
Camera：多格分鏡，主格 60%、兩小格 20% + 20%；無 DOF；快門 200；Style: Chromatic Comic Burst。
光影：平光 + 邊框燒蝕；高對比。
色調/LUT：飽和 +20%，對比 +20%。
...
Beat 11（12.0–13.2s）｜重點：爆光退去，雪花再次飄落
Blocking：冰晶碎片緩落，戰旗慢慢解凍，重弩冒白煙。
Camera：50mm 胸高；單點對焦蓮臉；快門 180。
光影：主光回到冷月 + 熔岩反光；對比中等。
色調/LUT：陰影微藍，高光暖 8%。
聲音：碎冰落地 -12 dB；蒸汽「シュー」-10 dB；音樂慢降 70 BPM。
物理/質感：冰晶受重力 9.8 m/s² 緩落；蒸汽對流 0.6 m/s；戰旗布料粗糙 0.55 冰霜融化滴水 0.05g/s。
轉場：直接切。
Angle A11
構圖：前景落雪，中景蓮，後景裂谷；留白 12%。
內容：能量槽光降至 20%，斗篷邊緣蒸汽白霧。
補充：膚質分層—base 0.35 粗糙，SSS 0.12，specular 0.5；衣料纖維 4k 清晰。
安全：無字。

Beat 12（13.2–15.0s）｜重點：風重新安靜，蓮帶著重弩離場
Blocking：緩推近側臉，蓮抬頭看雪，扛弩轉身，蒸汽繞出白霧。
Camera：70mm 胸高；單點對焦眼；快門 180。
光影：主光柔和，體積霧淡；對比柔。
色調/LUT：膚色優先，去飽和 5%。
聲音：風聲漸弱 -14 dB；金屬收納「カタッ」-8 dB；遠方雪崩低鳴 -12 dB。
物理/質感：斗篷摩擦係數 0.45，步伐踩碎冰 0.6cm；呼吸白霧 0.3s；重弩冷卻蒸汽 45℃ 環繞肩頭。
轉場：淡出黑 0.3s。
Angle A12
構圖：側臉中近景，最後定格背影居中；留白 18%。
內容：蓮扛弩向裂谷深處走，腳邊碎冰被踩裂，雪花再度飄落。
補充：眼神從緊繃→放鬆，虹膜反光熔岩餘光；肩上蒸汽繞出白霧。
安全：無文字。
# Platform Layer
- Hook A（故事向）0–1s：裂谷全景 + 定格雪點與戰旗；Hook B（衝擊向）9.6–12s 漫畫爆炸「最後一矢」。
- First-shot visual hook: 懸浮戰旗、雪點停在空中、雲層旋轉。
- Subtitles/Caption：主檔無字幕；短版可加「最後一矢」2 字或「風也停下來了」四字，位置右下，生成時移除。
...
- 切片輸出策略：短版剪 0–1s、9.6–12s；長版全長 15s；字幕行對應 Hook 句「就用這一發」或「最後一矢」可後期上字。
